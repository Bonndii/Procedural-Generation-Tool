...
Shader "Bark_mat"
{
	Properties
	{
		...
		[ASEBegin]_Conifer_Color("Conifer_Color", 2D) = "white" {}
		[ASEEnd]_Conifer_Normal("Conifer_Normal", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _Conifer_Color_ST;
			float4 _Conifer_Normal_ST;
			...
			#endif
			CBUFFER_END
			sampler2D _Conifer_Color;
			sampler2D _Conifer_Normal;
						...
						)
			{
				...
				float2 uv_Conifer_Color = packedInput.ase_texcoord5.xy * _Conifer_Color_ST.xy + _Conifer_Color_ST.zw;
				
				float2 uv_Conifer_Normal = packedInput.ase_texcoord5.xy * _Conifer_Normal_ST.xy + _Conifer_Normal_ST.zw;
				
				surfaceDescription.Albedo = tex2D( _Conifer_Color, uv_Conifer_Color ).rgb;
				surfaceDescription.Normal = tex2D( _Conifer_Normal, uv_Conifer_Normal ).rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Conifer_Color = packedInput.ase_texcoord.xy * _Conifer_Color_ST.xy + _Conifer_Color_ST.zw;
				
				float2 uv_Conifer_Normal = packedInput.ase_texcoord.xy * _Conifer_Normal_ST.xy + _Conifer_Normal_ST.zw;
		...
		Pass
		{
					...
					)
			{
				...
				float2 uv_Conifer_Normal = packedInput.ase_texcoord3.xy * _Conifer_Normal_ST.xy + _Conifer_Normal_ST.zw;
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_Conifer_Color = packedInput.ase_texcoord7.xy * _Conifer_Color_ST.xy + _Conifer_Color_ST.zw;
				
				float2 uv_Conifer_Normal = packedInput.ase_texcoord7.xy * _Conifer_Normal_ST.xy + _Conifer_Normal_ST.zw;
...
ASEEND*/
//CHKSM=4BB2CBACD48F90A4F2CB51886DE7CC66C2138620